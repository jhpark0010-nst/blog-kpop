...
# ── RSS 피드 소스 ──
# 2026-04-24 확장: MyDaily 2종 + TVReport 추가. 기존 2종(연합뉴스·스포츠동아)
# 만으론 K-pop 유입이 하루 15~20건 수준이라 Writer 8회/일 소진 못 따라감.
RSS_FEEDS = {
    "연합뉴스_엔터": {
    ...
    "MyDaily_뮤직": {
        # K-pop 순도 거의 100% (앨범/콘서트/컴백/빌보드). 25 items.
        "url": "https://mydaily.co.kr/music_rss.xml",
        "category": "K-pop",
        "priority": 1,
    },
    "MyDaily_스타": {
        # 연예 종합. K-pop 아이돌 비중 40%+. 30 items, 이미지 품질 최상.
        "url": "https://mydaily.co.kr/star_rss.xml",
        "category": "K-pop",
        "priority": 2,
    },
    "TVReport": {
        # 50 items, 안정. K-pop 30%, 드라마/예능 커버리지 보완.
        "url": "https://www.tvreport.co.kr/rss",
        "category": "K-pop",
        "priority": 2,
    },
}
...
# ── Writer ──
# 번역 중심 블로그. 원문 분량 근사치 (300~500 단어).
WRITER_TARGET_WORD_COUNT_MIN = 300
WRITER_TARGET_WORD_COUNT_MAX = 500
WRITER_ARTICLES_PER_RUN = 3  # 1회 실행당 생성할 글 개수
